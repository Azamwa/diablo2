...
const HuntCount = () => {
  ...
  return (
    <div>
      <h2 className="mb-5 text-4xl font-semibold text-gray-300">디아2 사냥 횟수 & 드랍템</h2>
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-700">
            <TableHead className="w-[200px] text-lg text-gray-400">장소</TableHead>
            <TableHead className="w-[200px] text-lg text-gray-400">카운트</TableHead>
            <TableHead className="w-[1000px] text-lg text-gray-400">드랍아이템</TableHead>
          </TableRow>
        </TableHeader>
